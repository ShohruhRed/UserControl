...
namespace UserControl.Migrations
{
    ...
    [Migration("20220903184424_ModelRelationship")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserControl.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UserControl.Models.Car_CarManafacturer", b =>
                {
                    ...
                    b.Property<int>("CarmanId")
                        .HasColumnType("int");

                    b.HasKey("CarId", "CarmanId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UserControl.Data.ApplicationUser", null)
                        .WithMany()
